...
def generate_pipeline():
	...
	pipeline.add_command_step({
		...
		"commands": [
			...
			"twine upload -u __token__ -p \"$(buildkite-agent oidc request-token --audience 'https://packages.buildkite.com/nunciato/bazel-buildkite-emojis' --lifetime 300)\" --repository-url 'https://packages.buildkite.com/nunciato/bazel-buildkite-emojis' bazel-bin/emojis/dist/emojis-0.0.1-py3-none-any.whl"
		],
		"depends_on": [
			"test",
			"build",
